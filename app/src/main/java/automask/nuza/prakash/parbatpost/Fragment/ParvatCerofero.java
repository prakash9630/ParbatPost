...
public class ParvatCerofero extends Fragment {
    View mainView;
    ProgressDialog pDilog;
    FeatureData data;
    ArrayList<FeatureData> datalist;
    String url= Public_URL.localnews;
    RecyclerView recyclerView;
    ParvatAdapter adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mainView=inflater.inflate(R.layout.parvatcerofero_layout,container,false);
        ...
        recyclerView=(RecyclerView)mainView.findViewById(R.id.parvatnews_list);
            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i=0;i<response.length();i++)
                {
                    try {
                        ...
                        adapter=new ParvatAdapter(getContext(),datalist);
...
class ParvatAdapter extends RecyclerView.Adapter<ParvatHolder>
{
    Context contex;
    LayoutInflater layoutinflater;
    ArrayList<FeatureData> data;

    public ParvatAdapter(Context contex, ArrayList<FeatureData> data) {
        this.contex = contex;
    ...
    @Override
    public ParvatHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view=layoutinflater.inflate(R.layout.news_display_design,parent,false);
        ParvatHolder holder=new ParvatHolder(view,contex,data);
        return holder;
    }

    @Override
    public void onBindViewHolder(ParvatHolder holder, int position) {
...
class ParvatHolder extends RecyclerView.ViewHolder implements View.OnClickListener
{
    ImageView image;
    TextView textview;
    ...
    public ParvatHolder(View itemView, Context context, ArrayList<FeatureData> data) {
        super(itemView);
